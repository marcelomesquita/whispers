    ...
    <>
      <header className="d-flex flex-column text-center p-3">
        ...
        <a href="#" className=" text-decoration-none">
          <span className="fs-3">@fernandaessenciais</span>
        </a>
        ...
        <div class="row justify-content-md-center">
          <div class="col col-lg-8">
            <div className="d-grid gap-2">
              <a href="https://www.mydoterra.com/fernandaessenciais/#/joinAndSave" target="_blank" className="btn btn-lg btn-primary text-white">
